...
<table class="table table-bordered table-hover table-striped">
    <tr>
        <form method="post" action="index.php?page=search_charged_cash">
            <td colspan="5">
                <input type="text" placeholder="Search table" name="searchChargedCash" class="form-control" required />
            </td>
            <td colspan="3">
    ...
    <tr>
        <td colspan="8"><a href="index.php?page=create_charged_cash"><button class="btn btn-success btn-sm"><span
